function euroConverter(){ // Converts European Euro
...
function dollarConverter(){ // Converts American Dollar
...
function poundConverter(){ // Converts British Pound
...
function yenConverter(){ // Converts Japanese Yen
